...
<figure><img class="size-full wp-image-190 " title="Sum of Integers 1..n" alt="Sum of Integers" src="/images/sumofintegersformula1.png" width="109" height="42" /><figcaption> Sum of Integers </figcaption></figure>

<figure><img class="size-full wp-image-191 " alt="Sum of Squares" src="/images/sumofsquaresformula1.png" width="180" height="45" /><figcaption> Sum of Squares Identity</figcaption></figure>
...
<figure><img class="size-medium wp-image-196" alt="Test for a sum of squares method" src="/images/test12.png?w=300" width="300" height="185" /><figcaption> Test for a sum of squares method </figcaption></figure>

And here is the output for that test:

<figure>><img class="size-medium wp-image-197" alt="Output from run of first test." src="/images/test1-output2.png?w=300" width="300" height="118" /><figcaption> Output from run of first test.</figcaption></figure>
...
<figure><img class="size-medium wp-image-198" alt="Output from 2nd test run" src="/images/test1-output21.png?w=300" width="300" height="128" /><figcaption> Output from 2nd test run</figcaption></figure>
...
<figure><img class="size-medium wp-image-199" alt="Solution Class" src="/images/class1.png?w=300" width="300" height="92" /><figcaption> Solution Class</figcaption></figure>
...
<figure><img class="size-medium wp-image-200" alt="Result from pass 3 of test 1" src="/images/test1-output3.png?w=300" width="300" height="125" /><figcaption> Result from pass 3 of test 1</figcaption></figure>
...
<figure><img class="size-full wp-image-201" alt="Test1 - Passing!" src="/images/test1-output4.png" width="248" height="126" /><figcaption> Test1 - Passing!</figcaption></figure>
...
<figure>><img class="size-medium wp-image-202" alt="Test 2 for a square of sums method" src="/images/test2.png?w=300" width="300" height="58" /><figcaption> Test 2 for a square of sums method</figcaption></figure>
...
<figure><img class="size-medium wp-image-203" alt="Output from Test 2" src="/images/test2-output.png?w=300" width="300" height="97" /><figcaption> Output from Test 2</figcaption></figure>

<figure><img class="size-medium wp-image-204" alt="Square of Sums method" src="/images/class2.png?w=300" width="300" height="60" /><figcaption> Square of Sums method</figcaption></figure>

And now our test 2 passes.

<figure><img class="size-full wp-image-205" alt="Test 2 - Passing!" src="/images/test2-output2.png" width="234" height="120" /><figcaption> Test 2 - Passing!</figcaption></figure>
...
<figure><img class="size-medium wp-image-206" alt="The complete test class" src="/images/testclass.png?w=300" width="300" height="223" /><figcaption> The complete test class</figcaption></figure>

<figure><img class="size-medium wp-image-207" alt="Complete solution class" src="/images/solutionclass.png?w=300" width="300" height="288" /><figcaption> Complete solution class</figcaption></figure>
...
<figure><img class="size-medium wp-image-209" alt="All Tests Passing!" src="/images/testclass-output.png?w=300" width="300" height="68" /><figcaption> All Tests Passing!</figcaption></figure>

<figure><img class="size-full wp-image-210" alt="Results!" src="/images/solution-output.png" width="217" height="76" /><figcaption> Results!</figcaption></figure>
